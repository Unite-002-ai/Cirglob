    ...
    <div className="w-full rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-4 space-y-4">
      <div className="flex items-center gap-3">
        <input
          ...
          className="flex-1 bg-white/5 border border-white/10 text-white text-sm px-4 py-3 rounded-xl outline-none focus:border-[#7C8CFF]/40 focus:bg-white/10 transition"
        />
