...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Case 1: Email confirmation required (Supabase default behavior)
      if (result.needsEmailConfirmation) {
        router.push("/auth/access");
        return;
      }

      // Case 2: session exists → user is already logged in
      if (result.session) {
          ...
          <div className="relative rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-2 text-sm text-gray-400">
                Join Cirglob to build and scale impactful startups
              </p>
