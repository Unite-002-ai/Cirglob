...
const ALL_JOBS: Job[] = [
  ...
  },
  {
    ...
    slug: "orbitlabs",
    batch: "W26",
    mission: "Next-generation AI agents for enterprise workflows",
  ...
  const filteredJobs = useMemo(() => {
    ...
    return ALL_JOBS.filter((job) => {
      const matchesSearch =
        ...
        job.mission.toLowerCase().includes(q);

      const matchesCompany =
        !companyFilter ||
        job.company.toLowerCase().includes(companyFilter) ||
        job.slug.toLowerCase() === companyFilter;
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  ...
                  <div className="flex flex-col md:items-end gap-3">
                    <div className="text-sm text-white/70">{job.salary}</div>
